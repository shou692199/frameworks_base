...
package com.android.internal.notification.custom;
...
public final class CustomNotificationLights {
    private static final String TAG = "CustomNotificationLights";
    ...
    public CustomNotificationLights(Context context, LedUpdater ledUpdater) {
        mContext = context;
    ...
    public boolean isForcedOn(Notification n) {
        if (n.extras != null) {
            return n.extras.getBoolean(CustomNotification.EXTRA_FORCE_SHOW_LIGHTS, false);
        }
        return false;
    }
    ...
    private int getForcedBrightness(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(CustomNotification.EXTRA_FORCE_LIGHT_BRIGHTNESS, 0);
        }
        return 0;
    }
    ...
    public int getForcedColor(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(CustomNotification.EXTRA_FORCE_COLOR, 0);
        }
        return 0;
    }
    ...
    public int getForcedLightOnMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(CustomNotification.EXTRA_FORCE_LIGHT_ON_MS, -1);
        }
        return -1;
    }
    ...
    public int getForcedLightOffMs(Notification n) {
        if (n.extras != null) {
            return n.extras.getInt(CustomNotification.EXTRA_FORCE_LIGHT_OFF_MS, -1);
        }
        return -1;
    }
